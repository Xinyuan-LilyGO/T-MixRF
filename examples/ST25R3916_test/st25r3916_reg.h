...
//  */
// void st25r3916_read_reg(uint8_t reg, uint8_t *val);
...
//  */
// void st25r3916_write_reg(uint8_t reg, uint8_t val);
...
//  */
// void st25r3916_reg_write_fifo(const uint8_t *buff, uint32_t length);
...
//  */
// void st25r3916_reg_read_fifo(uint8_t *buff, uint32_t length);
...
//  * @param   length      - number of bytes to write
//  */
// void st25r3916_write_pta_mem(const uint8_t *values, uint32_t length);
...
//  * @param   length      - number of bytes to read
//  */
// void st25r3916_read_pta_mem(uint8_t *values, uint32_t length);
...
//  * @param   length      - number of bytes to write
//  */
// void st25r3916_write_ptf_mem(const uint8_t *values, uint32_t length);
...
//  * @param   length      - number of bytes to write
//  */
// void st25r3916_write_pttsn_mem(uint8_t *values, uint32_t length);

// /** Send Direct command
//  *
//  * @param   cmd         - direct command
//  */
// void st25r3916_direct_cmd(uint8_t cmd);

// /** Read test register
//  * @param   reg         - register address
//  * @param   val         - pointer to the variable to store the read value
//  */
// void st25r3916_read_test_reg(uint8_t reg, uint8_t *val);
...
//  * @param   val         - value to write
//  */
// void st25r3916_write_test_reg(uint8_t reg, uint8_t val);
...
//  */
// void st25r3916_clear_reg_bits(uint8_t reg, uint8_t clr_mask);
...
//  */
// void st25r3916_set_reg_bits(uint8_t reg, uint8_t set_mask);
